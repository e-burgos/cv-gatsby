    ...
    return ( 
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a className="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src="/images/others/profile.jpg" alt="" /></span>
            </a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item"><a className="nav-link" rel="noreferrer" href="https://estebanburgos.com.ar/documents/cv_esteban_burgos_spanish_version.pdf" target="_blank"><small>Descargar CV</small></a></li>
                    { language.lang === 'es' ? 
